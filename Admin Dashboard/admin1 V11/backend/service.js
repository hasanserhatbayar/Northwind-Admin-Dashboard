...
//   function getEmployeeFullName(item) {
//     for (let i = 0; i < orders.length; i++) {
//         for (let j = 0; j < employeesArr.length; j++) {

//             if(item.employeeId==employeesArr[j].employeeId){
//                 const name=employeesArr[j].firstName+' '+employeesArr[j].lastName;
//                 return name;
//             }
...
// }
// const employee=orders.map(getEmployeeFullName);
